...
import { GetPatientClientsHandler } from './application/handlers/queries/get-patient-account.handler';
...
import { GetPsychologistClientsHandler } from './application/handlers/queries/get-psychologist-account.handler';
